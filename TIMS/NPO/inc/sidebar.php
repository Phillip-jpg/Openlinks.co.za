                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Registration <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="company_documentation.php">Company Documentation</a></li>
                      <li><a href="expense_summary.php">Expense Summary</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-link"></i> myBBBEE <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="myBBBEE_ALL.php">All Companies</a></li>
                      <li><a href="myBBBEE_NR.php">NPO Requested</a></li>
                      <li><a href="myBBBEE_CR.php">Company Requested</a></li>
