...
<html lang="en">
  ...
  <?php $filepath = realpath(dirname(__FILE__));
    ...
    <input type="text" name="tk" id="tk" value="<?php echo token::get("MYSMME_CHARTS_YASC");?>" required="" hidden>
          ...
          <div class="page-title">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Comparitive chart based on entity system rating</small></h2>
                  ...
                  <div class="x_content" >
                    <br />
                    <div class="chart-container" id="chart_cont" style="position: relative; height:inheret; width:inheret; margin-top: 10px; padding:10px;">
                      <canvas class="d-flex justify-content-center align-items-center" id="comparitive_Chart" style="position: relative; height:inheret; width:inheret"></canvas>
                    </div>
                  </div>
                </div>
              </div>
...
<script src="../Javascript/Vendor/jquery-3.5.1.js"></script>
  ...
  <script src="../Javascript/Vendor/Chart.js/dist/Chart.min.js"></script>
    ...
    <script src="../Javascript/mySMME_Chart.js" async></script>
