                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-edit"></i> Registration <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <li><a href="products_services.php">Products & Services</a></li>
                            <li><a href="keywords.php">Keywords</a></li>
                            <li><a href="business_links.php">Business links</a></li>
                        </ul>
                    </li>
                    <li><a href="edit.php"><i class="fa fa-edit"></i> Edit Profile </a></li>
                    <li><a><i class="fa fa-link"></i> CSR HUB <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="mySMME_ALL.php?page=1">Initiate CSR </a></li>
                            <li><a href="mySMME_CR.php">CSR Initiated</a></li>
                            <li><a href="mySMME_SR.php">Beneficiary Requests</a></li>
                            <li><a href="mySMME_Chart.php">Comparative Charts</a></li>
                        </ul>
                    </li>

                    <li><a><i class="fa fa-black-tie"></i> My Consultant <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="consultant.php?page=1">My Consultant</a></li>
                            <li><a href="consultant_link.php">Create consultant link</a></li>
                        </ul>
                    </li>
