...
<!-----end of content---->
                ...
                <table>
                    ...
                    <tr>
                        <td id="move">
                            <input class="form-control col-md-7 col-xs-12 formz" type="text" name='links[]' placeholder="Enter you business links here...">
                        </td>
                    ...
                    <tr>
                        <td id="move">
                            <select class="form-control col-lg-1 col-md-7 col-xs-12 formz" name='ids[]'>
                ...
                <?php $filepath = realpath(dirname(__FILE__));
                      ...
                      <input style="display:none" type="text" name="tk" value="<?php echo token::get("company_business_links");?>" required="" hidden>
