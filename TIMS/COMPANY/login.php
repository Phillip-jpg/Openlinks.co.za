      ...
      <div class="login_wrapper">
        ...
        <div class="image"></div>
          <section class="login_content">
            ...
            echo token::get_unauth("COMPANYLOGINYASC");
            ?>" required="" hidden>
              <div>
              ...
              <div>
              <div  style="margin-left:138px !important; font-family:segoe ui">
                <input type="submit" name="COMPANYLOGIN" value="login" class="btn btn-round btn-default login" style="width:80px !important">
              </div>
              <br>
        ...
        <div class="image"></div>
          <section class="login_content">
            ...
            ?> method="POST">
              ...
              <input type="text" name="tk" value="
            <?php
            echo token::get_unauth("COMPANYSIGNUPYASC");
            ?>" required="" hidden>
              <div>
              ...
              <div>
                <input type="password" name="pwd" class="form-control inputs" placeholder="Password" required="" />
              </div>
              <div>
              ...
              <div class="signupcom">
                <input style="margin-left:170px !important; width:100px" value="Signup" type="submit" name="COMPANYSIGNUP" class="btn btn-round btn-default submit">
              </div>
