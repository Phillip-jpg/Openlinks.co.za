  ...
  <div class="page-title">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 class="text-capitalize">Company information <small>fill in information about your company </small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../Main/Main.php" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" id="middle-name" class="form-control col-md-7 col-xs-12 formz" type="text" name="email">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" id="middle-name" class="form-control col-md-7 col-xs-12 formz" type="text" name="province">
                        </div>
                      </div>
                        <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">City</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" id="middle-name" class="form-control col-md-7 col-xs-12 formz" type="text" name="city">
                        </div>
                      </div>
                      <!-- Modal content-->
                  ...
                  <!-----end of content---->
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("COMPANYREGISTER");?>" required="" hidden>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
						  <button class="btn btn-primary" type="reset">Cancel</button>
                          <button name="COMPANYREGISTER" type="submit" class="btn btn-success">Submit</button>
                        </div>
                      </div>
