...
<html lang="en">
  ...
  <div class="container body">
    ...
    <input type="text" name="tk" id="tk" value="<?php echo token::get("CHAMS_NOTIFICATIONS_SINGLE_YASC");?>" required="" hidden>
    <?php if (isset($_GET['url'])){
      echo '<input type="text" name="url" id="url" value="'.$_GET['url'].'" required="" hidden>';
    }else{
      echo '<input type="text" name="url" id="url" value="" required="" hidden>';
    }?>
  ...
  <script src="../JavaScript/chams-SAJAX.js" async></script>
  <script>
