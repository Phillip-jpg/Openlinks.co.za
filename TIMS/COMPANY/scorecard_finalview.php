...
<!-----end of content---->
            ...
            <?php 
                                                        ...
                                                        $filepath = realpath(dirname(__FILE__));
                                                            ...
                                                            if(isset($_GET['t'])){
                                                                ...
                                                                $temp->displayCard($_GET['w']);
                                                            }
                                                        
                                                        ?>
            
            <div     class="text-center"><div class="btn col-3"><a href="scorecard_edit.php?t=1&w=<?php print_r($_GET["w"])?>"><span>Edit Information </span> <i class="fa fa-pencil"></i></a> </div>
              ...
              $filepath = realpath(dirname(__FILE__));
                ...
                switch($_GET["t"]){
                  case 1:
                    ...
                    $type= $temp->classname; 
                    $temp= new USER($id, $type);
                    $temp->displayLastCriteriaQuestions();
                  break;
                  case 2:
                    include_once($filepath.'/../classes/COMPANY.class.php');
                    include_once($filepath.'/../MARKET/USER.php');
           ...
           ?>
              ...
              <a href="scorecard_view.php?t=1"><button type="button" id="clicked" class="btn btn-info btn-lg">Done</button></a>
                    </div>
