              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php $filepath = realpath(dirname(__FILE__));
                    ...
                    <br />
                    <input id="link" style="width:70vw" class="form-control col-xl-12 col-lg-12 col-md-12 col-xs-12" value=""></input>
                   
                    <button id="copy_button" class="btn btn-rounded btn-info "> Copy</button>
                  </div>
                </div>
              </div>
             </div>
