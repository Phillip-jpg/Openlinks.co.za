    ...
    <input type="text" name="tk2" id="tk2" value="<?php echo token::get("LINK_VISITS_YASC");?>" required="" hidden>
        <?php 
            include_once($filepath.'/../helpers/token.php');
                        ...
                        $tk = $_POST['tk'];
                        if(($_SESSION['WHO']=="COMPANY") && (!isset($_GET['t'])||isset($_GET['t']) && $t == "SMME") && (isset($_POST['VIEW_MORE'])&&isset($_POST['tk']) && token::val($_POST['tk'], 'VIEW_MORE_YASC'))){//t is type of entity and 7 meaning smme
                        ...
                        else if((($_SESSION['WHO']=="COMPANY")|| ($_SESSION['WHO']=="P_COMPANY"))&& isset($_GET['t'])&&($t == "COMPANY") && (isset($_POST['VIEW_MORE'])&&isset($_POST['tk']) && token::val($_POST['tk'], 'VIEW_MORE_YASC'))){
                          include_once "../classes/COMPANY.class.php";
          
                            $temp = new COMPANY();     
                            $temp->COMPANY_TO_COMPANY_view_moreInfo($id);
                        }
