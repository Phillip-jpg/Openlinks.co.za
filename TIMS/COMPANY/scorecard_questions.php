...
<!-----end of content---->
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../MARKET/ROUTE.php?d=1" Method="POST">
                <table>
                    ...
                    <tr>
                        ...
                        <td id="move">
                            <select class="form-control col-lg-1 col-md-7 col-xs-12" placeholder="Enter your question here..." name='weights[]'>
                            <option value="SA_ID" placeholder="Enter your question here...">Select a weighting for your question </option>
