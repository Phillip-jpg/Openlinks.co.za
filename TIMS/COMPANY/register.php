                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Post Code<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Company contact<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      ...
                      <div class="form-group">
                      <label for="offices" class="control-label col-md-3 col-sm-3 col-xs-12">Business Offices</label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="offices" id="offices" class="form-control" required>
                    ...
                    <div class="form-group">
                    <label for="industries" class="control-label col-md-3 col-sm-3 col-xs-12">Business Industries</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="industries" class="form-control" id="industries" disabled required></select>                        </div>
                      </div>
