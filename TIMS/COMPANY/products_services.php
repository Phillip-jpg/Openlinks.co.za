...
<!-----end of content---->
                ...
                <table style="margin:auto" class="pandservices">
                    ...
                    <tr>
                        ...
                        <td id="move">
                            <input required="required" class="form-control col-lg-7 col-md-3 col-xs-12 formz" type="text" name='productname[]' placeholder=" Product name...">
                        </td>
                    </tr>
                    <tr>
                        <td >
                            <input required="required"  class="form-control col-lg-7  col-md-3 col-xs-12 formz" type="text" name='productdes[]' placeholder=" product description...">
                        </td>
                    </tr>
                    <tr>
                        <td >
                            <input  class="form-control col-lg-7  col-md-3 col-xs-12 formz" type="number" name='productprice[]'placeholder=" product price..." >
                        </td>
                    </tr>
                    <tr>
                        <td >
                ...
                <?php $filepath = realpath(dirname(__FILE__));
                      ...
                      <input style="display:none" type="text" name="tk" value="<?php echo token::get("COMPANYPRODUCTSYASC");?>" required="" hidden>

                <input class="btn btn-success product" type="submit" style="margin-left:290px" name="COMPANYPRODUCTS" >
            </form>
        </div>
    </div>
