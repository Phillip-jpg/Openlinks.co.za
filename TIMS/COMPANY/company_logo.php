    ...
    <div class='align-self-center tab-content' style='display: flex; margin:auto ;'>
        <div id="" class='tab-pane fade in active' style="width: 50vw !important; margin:auto">
            <form id="behave" action="../Main/Main.php" method="POST" enctype="multipart/form-data">
                <?php $filepath = realpath(dirname(__FILE__));
                    include_once($filepath.'/../helpers/token.php');?>
                    <input type="text" name="tk" value="<?php echo token::get("COMPANYLOGOYASC");?>" required="" hidden>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button name="COMPANYLOGOUPDATE" type="submit" class="btn btn-success">Submit</button>
                        </div>
                      </div>
