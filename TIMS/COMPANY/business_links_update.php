...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <input type="text" name="tk" value="<?php echo token::get("COMPANYLINKSDELETEYASC");?>" required="" hidden>

            
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="button" class="btn btn-default" ><a href="edit.php">Cancel</a></button>
                <button type="submit" class="btn btn-danger" name="COMPANYLINKSDELETE">Delete <span><i class="fa fa-trash"></i></span></button>
              </div> 
...
<button type="button" id="clicked" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="display:none"></button>
    ...
    <div class='align-self-center tab-content' style='display: flex; margin:auto ;'>
        <div id="" class='tab-pane fade in active' style="width: 50vw !important; margin:auto">
            <form id="COMPANYLINKSUPDATEFORM" action="../Main/Main.php" method="POST">
                <?php $filepath = realpath(dirname(__FILE__));
                    include_once($filepath.'/../helpers/token.php');?>
                    <input type="text" id="tk2" name="tk" value="<?php echo token::get("COMPANYLINKSUPDATEYASC");?>" required="" hidden>
...
<script src="../Javascript/Vendor/jquery-3.5.1.js"></script>
  ...
  <script src="../Javascript/deletemodal.js"></script>
    ...
    <script src="../Javascript/link_checkbox.js" defer></script>
    </body>
</html>
