...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <input type="text" name="tk" value="<?php echo token::get("COMPANYREGISTERDELETEYASC");?>" required="" hidden>

            
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="button" class="btn btn-default" ><a href="edit.php">Cancel</a></button>
                <button type="submit" class="btn btn-danger" name="COMPANYREGISTERDELETE">Delete <span><i class="fa fa-trash"></i></span></button>
              </div> 
...
<button type="button" id="clicked" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="display:none"></button>
                    ...
                    <?php $filepath = realpath(dirname(__FILE__));
                    include_once($filepath.'/../helpers/token.php');?>
                    <input type="text" name="tk" value="<?php echo token::get("COMPANYREGISTERUPDATEYASC");?>" required="" hidden>
