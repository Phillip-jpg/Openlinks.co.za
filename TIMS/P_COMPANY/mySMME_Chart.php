          ...
          <div class="page-title">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>mySMME <small>Where all your connections are made</small></h2>
                  ...
                  <div class="x_content" >
                    <br />
                    <div class="chart-container" style="position: relative; height:inheret; width:inheret; margin-top: 10px; padding:10px;">
