    ...
    <input type="text" name="tk" id="tk" value="<?php echo token::get("VIEW_MORE_CHARTS_YASC");?>" required="" hidden>
        ...
        <?php 
            include_once($filepath.'/../helpers/token.php');
                        ...
                        $tk = $_POST['tk'];
                        if((($_SESSION['WHO']=="COMPANY") || ($_SESSION['WHO']=="P_COMPANY"))&& (isset($_POST['VIEW_MORE'])&&isset($_POST['tk']) && token::val($_POST['tk'], 'VIEW_MORE_YASC'))){//t is type of entity and 7 meaning smme
