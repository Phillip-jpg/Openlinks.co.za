...
class adminReview{
    ...
    private function password(){
        ...
        <div  class="tab-pane fade in active" style="width: 50vw !important; margin:auto">
            <form id="behave" action="../Main/Main_ADMIN.php" method="POST" >';

            $filepath = realpath(dirname(__FILE__));
            include_once($filepath.'/../../helpers/token.php');

         $display .=  '<input type="text" name="tk" value=';
        $display .=  token::get_ne("ADMINPASSWORDYASC");
        $display .= ' required hidden>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <button name="ADMINPASSWORDUPDATE" type="submit" class="btn btn-success">Submit</button>
                      </div>
                    </div>
