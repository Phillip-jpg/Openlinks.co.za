              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2>Admin Information <small>fill in admin information...</small></h2>
...
<!-----end of content modal---->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="IDNumber">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Ethinic Group</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <input style="width:35vw" name="Race" list="Ethnicc1" class="form-control col-md-7 col-xs-12">
             ...
             <option value="Indian">Indian</option>
                ...
                <select style="width:35vw" class="form-control col-md-7 col-xs-12" name="Gender" size="1">
                    ...
                    <!--Other not relavent-->
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("CONSULTANTREGISTER");?>" required="" hidden>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button class="btn btn-primary" type="button">Cancel</button>
						  <button class="btn btn-primary" type="reset" >Reset</button>
              <button type="submit" class="btn btn-success" name="CONSULTANTREGISTER">Submit</button>
                        </div>
                      </div>
