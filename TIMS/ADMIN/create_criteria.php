            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../MARKET/ROUTE.php?dest=2" Method="POST">
                  ...
                  <!-----end of content modal---->
                    ...
                    <div class="form-group">
                        ...
                        <a  class="btn btn-primary" href="criteria_view.php?t=3">Back</a>
