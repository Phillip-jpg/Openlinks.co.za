  ...
  <div class="page-title">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Edit option information</small></h2>
            ...
            $filepath = realpath(dirname(__FILE__));
              ...
              switch($_GET["t"]){
                ...
                case 3:
                  ...
                  $temp->editOption($_GET['w'], $_GET['s'], $_GET['d']);
                break;
              }
           }
           ?>
                     <a  class="btn btn-primary" href="question_options.php?s=<?php echo $_GET['s']?>&w=<?php echo $_GET['q']?>&t=3&d=2">Back</a>
                  </div>
                </div>
              </div>
             </div>
