...
<!-----end of content modal---->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" id="contact"  name="contact" class="form-control col-md-7 col-xs-12" type="number" >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" id="role" class="form-control col-md-7 col-xs-12" type="text" name="role">
                        </div>
                      </div>
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("CREATEREP_OPENLINKS");?>"  hidden>
                      <input type="text" name="client_id" value="<?php echo $_GET['u'];?>"  hidden>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          
						  <button class="btn btn-primary" type="reset" >Reset</button>
              <button type="submit" class="btn btn-success" name="CREATEREPRESENTATIVE" >Submit</button>
                        </div>
                      </div>
