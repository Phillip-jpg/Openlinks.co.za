...
<html lang="en">
  ...
  <?php $filepath = realpath(dirname(__FILE__));
    ...
    <input type="text" name="tk" id="tk" value="<?php echo token::get("ADMIN_VIEW_SMME_YASC");?>" required="" hidden>
      ...
      <div class="right_col" role="main">
              ...
              <div class="page-title">
                  <div class="title_left">
                    <h3>SMME</h3> <small><form action="../Main/Main_ADMIN.php" method="POST"><button class="btn" type="submit" name="PRINT_SMME_EXCEL"><i class="fa fa-print"></i></button></form></small>
                  </div>
                  ...
                  <div class="clearfix"></div>
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_content" >
                            <div id="mySMME" class="col-md-12 col-sm-12 col-xs-12">
...
<script src="../Javascript/Vendor/jquery-3.5.1.js"></script>
  ...
  <script src="../Javascript/Vendor/datatables.min.js"></script>
    ...
    <script src="../Javascript/adminSMME.js" async></script>
