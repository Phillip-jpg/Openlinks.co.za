            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../MARKET/ROUTE.php?d=1&w=<?php echo $_GET['w']?>" Method="POST">
                    <?php
            ...
            $filepath = realpath(dirname(__FILE__));
              ...
              switch($_GET["t"]){
                ...
                case 3:
                  ...
                  $temp->adjustScorecardWeights($_GET['s'], $_GET['w']);
                break;
              }
           }
           ?>
                  ...
                  <!-----end of content modal---->
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("WEIGHTADJUST_EDIT_OPENLINKS");?>" required="" hidden>
                      
                    
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a  class="btn btn-primary" href="scorecard_finalview2.php?w=<?php echo $_GET['s']?>&t=3">Back</a>
                          ...
                          <?php 
                            if(isset($_GET['t'])){
                              switch($_GET['t']){
                                case 1://smme
                                    echo '<button type="Submit" class="btn btn-success" name="SMME_CRITERIA_EDIT">Submit</button>';
                                    break;
                                case 2: //company
                                  echo '<button type="Submit" class="btn btn-success" name="COMPANY_CRITERIA_EDIT">Submit</button>';
                                  break;
                                case 3://adimin
                                  echo '<button type="Submit" class="btn btn-success" name="ADMIN_WEIGHTADJUST_EDIT">Submit</button>';
                                  break;
                              }
                            }
                          ?>
