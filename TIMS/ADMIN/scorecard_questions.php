                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Add questions to your created criteria </h3>
                        </div>
...
<!-----end of content---->
            <form id="question_form" data-parsley-validate class="form-horizontal form-label-left" action="../MARKET/ROUTE.php?d=1" Method="POST">
                <table>
                    ...
                    <tr>
                        <td id="move">
                            <input class="form-control col-md-7 col-xs-12" type="text" name='questions[]' placeholder="Enter your question here...">
                        </td>
                        <td id="move">
                            <input class="form-control col-md-7 col-xs-12" type="number" name='weights[]' placeholder="Enter your question weighting here..." >
                ...
                <?php $filepath = realpath(dirname(__FILE__));
                      ...
                      <input style="display:none" type="text" name="tk" value="<?php echo token::get("QUESTION_CREATION_OPENLINKS");?>" required="" hidden>
                      <input style="display:none" type="text" name="ADMIN_QUESTION_CREATE" value="ADMIN_QUESTION_CREATE" required="" hidden>
                <button class="btn" type="button" id="addItem">Add Question</button>
            ...
            <?php 
                            if(isset($_GET['t'])){
                              switch($_GET['t']){
                                case 1://smme
                                    echo '<button type="Submit" class="btn btn-success" name="SMME_QUESTION_CREATE">Submit</button>';
                                    break;
                                case 2: //company
                                  echo '<button type="Submit" class="btn btn-success" name="COMPANY_QUESTION_CREATE">Submit</button>';
                                  break;
                                case 3://adimin
                                  echo '<button type="Submit" id="QUESTION_CREATE" class="btn btn-success" name="ADMIN_QUESTION_CREATE">Submit</button>';
                                  break;
                              }
                            }
                          ?>
...
<div class="x_panel" >
            <h3 class="text-center">Criteria information</h3>
            <?php 
           if(isset($_GET["t"])){
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    ...
    <script src="../Javascript/weight_selection_question.js"></script>
    <script src="../Javascript/addFile.js"></script>
