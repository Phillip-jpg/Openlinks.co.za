...
<html lang="en">
  ...
  <div class="page-title">
           ...
           ?>
                  ...
                  <!-----end of content modal---->
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("SCORECARD_EDIT_OPENLINKS");?>" required="" hidden>
                      
                    
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a class="btn btn-primary" href="scorecard_finalview2.php?w=<?php echo $_GET['w']?>&t=3">Back</a>
                          ...
                          <?php 
                            if(isset($_GET['t'])){
                              switch($_GET['t']){
                                case 1://smme
                                    echo '<button type="Submit" class="btn btn-success" name="SMME_SCORECARD_EDIT">Submit</button>';
                                    break;
                                case 2: //company
                                  echo '<button type="Submit" class="btn btn-success" name="COMPANY_SCORECARD_EDIT">Submit</button>';
                                  break;
                                case 3://adimin
                                  echo '<button type="Submit" class="btn btn-success" name="ADMIN_SCORECARD_EDIT">Submit</button>';
                                  break;
                              }
                            }
                          ?>
  ...
  <script src="../Javascript/scorecard_edit.js"></script>
