...
<!-----end of content---->
            ...
            <div class="x_panel" >
            <h3 class="text-center">Work Type information</h3>'
            ...
            <?php 
                  ...
                  $filepath = realpath(dirname(__FILE__));
                      ...
                      if(isset($_GET['t'])){
                          ...
                          $temp->displaySingleWorkType($_GET['w']);
                      }
                  
                  ?>
            <a  class="btn btn-primary" href="worktype_view.php?t=3">Back</a>
