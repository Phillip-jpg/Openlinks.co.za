  ...
  <div class="page-title">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Edit question information</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../MARKET/ROUTE.php?w=<?php echo $_GET['w']?>" Method="POST">
                    <?php
           ...
           ?>
                  ...
                  <!-----end of content modal---->
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("QUESTION_EDIT_OPENLINKS");?>" required="" hidden>
                    ...
                    <div class="form-group" style="float:left">
                        ...
                        <?php
                          if($_GET['d'] == 2){
                            echo '<a  class="btn btn-primary" href="criteria_information.php?w='.$_GET["c"].'&t=3">Back</a>';
                          }else{
                            echo '<a  class="btn btn-primary" href="criteria_questions.php?s='.$_GET["s"].'&w='.$_GET["c"].'&t=3">Back</a>';
                          }
                        ?>
                          ...
                          <?php 
                            if(isset($_GET['t'])){
                              switch($_GET['t']){
                                case 1://smme
                                    echo '<button type="Submit" class="btn btn-success" name="SMME_QUESTION_EDIT">Submit</button>';
                                    break;
                                case 2: //company
                                  echo '<button type="Submit" class="btn btn-success" name="COMPANY_QUESTION_EDIT">Submit</button>';
                                  break;
                                case 3://adimin
                                  echo '<button type="Submit" class="btn btn-success" name="ADMIN_QUESTION_EDIT">Submit</button>';
                                  break;
                              }
                            }
                          ?>
