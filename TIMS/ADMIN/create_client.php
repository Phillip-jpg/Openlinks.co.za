                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="City">Company City:<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" type="text" id="first-name" name="City" required="required" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Province">Company Province:<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" type="text" id="first-name" name="Province" required="required" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      <!-- <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="RepName">Company Rep:<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" type="text" id="first-name" name="RepName" required="required" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div> -->
                      <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" type="number" id="first-name" name="Contact" required="required" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" type="email" id="first-name" name="Email" required="required" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div> -->
                  ...
                  <!-----end of content modal---->
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("CLIENT_CREATION_OPENLINKS");?>" required="" hidden>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <?php 
                            if(isset($_GET['t'])){//adimin
                                  echo '<button type="Submit" class="btn btn-success" name="ADMIN_CLIENT_CREATE">Submit</button>';
