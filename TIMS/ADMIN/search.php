                ...
                <div class="x_panel">
                  <div class="x_title">
                    <!-- <h2>Search <small>Find what you are looking for easily</small></h2> -->
                     <ul class='nav nav-pills row' style="border-radius: 30px !Important;">
        <li class='active col-sm-3 col-md-3 col-lg-3' style="border-radius: 30px;"><a style="border-radius: 25px;" data-toggle='pill' href='#search_menu1'>Search</a></li>
        <li class='col-sm-3 col-md-3 col-lg-3'><a style="border-radius: 25px;" data-toggle='pill' id="advanced_search_toggle" href='#search_menu2'>Advanced search</a></li>
...
<!-- 
                <input type="search" name="unauthSearchTerm" id="unauthSearchTerm" placeholder="Type here..." style="border: solid 1px !important; outline: none;" value="<?php if(isset($_GET['s'])) echo $_GET['s'];?>">
                    ...
                    <button class="btn" type="submit" id="search_btn" style="outline: none; border-radius:25px">
