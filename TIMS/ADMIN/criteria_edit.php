  ...
  <div class="page-title">
           ...
           ?>
                  ...
                  <!-----end of content modal---->
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("CRITERIA_EDIT_OPENLINKS");?>" required="" hidden>
                      
                    
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a  class="btn btn-primary" href="criteria_information.php?w=<?php echo $_GET['w']?>&t=3">Back</a>
                            ...
                            if(isset($_GET['t'])){
                              switch($_GET['t']){
                                ...
                                case 2: //company
                                  ...
                                  break;
                                case 3://adimin
                                  echo '<button type="Submit" class="btn btn-success" name="ADMIN_CRITERIA_EDIT">Submit</button>';
                                  break;
                              }
                            }
                          ?>
