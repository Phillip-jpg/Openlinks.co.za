...
<html lang="en">
  ...
  <?php $filepath = realpath(dirname(__FILE__));
    ...
    <input type="text" name="tk" id="tk" value="<?php echo token::get("MY_CONSULTANTS_YASC");?>" required="" hidden>
                  ...
                  <div class="clearfix"></div>
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_content" >
                            <div id="myConsultants" class="col-md-12 col-sm-12 col-xs-12">
...
<script src="../Javascript/Vendor/jquery-3.5.1.js"></script>
  ...
  <script src="../Javascript/Vendor/datatables.min.js"></script>
    ...
    <script src="../JavaScript/consultants.js" async></script>
