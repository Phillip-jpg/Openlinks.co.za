...
<!-- 
  ...
  <div class="right_col" role="main">
        ...
        <li class='active col-sm-3 col-md-3 col-lg-3'><a data-toggle='pill' style="border-radius: 25px;" href='#search_menu1'>Search</a></li>
        <li class='col-sm-3 col-md-3 col-lg-3'><a data-toggle='pill' style="border-radius: 25px;" id="advanced_search_toggle" href='#search_menu2'>Advanced search</a></li>
...
<!-- 
                <input type="search" name="unauthSearchTerm" id="unauthSearchTerm" placeholder="Type here..." style="border: solid 1px !important; outline: none;" value="<?php if(isset($_GET['s'])) echo $_GET['s'];?>">
                    ...
                    <button class="btn" type="submit" id="search_btn" style="outline: none;border-radius:30px;margin-left:10px">
    ...
    <div id='search_menu2' class='tab-pane fade' style="width:100%">
        ...
        <div class="row">
          ...
          <!-- Still needs to be gaffed -->
          <select name="Organisational_search" class="fooy form-control col-md-6 col-xs-12 col-lg-6" style="border: solid 2px rgb(191, 191, 209); border-radius:30px; ">
                        <option value="" selected> --blank-- </option>
                        <option value="Private">Private</option>
                        <option value="Not for profit organisation">Not for profit organisation</option>
        ...
        <div class="row">
          ...
          <select name="offices" class="officey form-control col-md-6 col-xs-12 col-lg-6" style="border: solid 2px rgb(191, 191, 209); border-radius:30px; " id="offices">
                        ...
                        <option value="Office of Energy and Transportation">Office of Energy and Transportation</option>
                        <option value="Office of Real Estate and Construction">Office of Real Estate and Construction</option>
                        ...
                        <option value="Office of Trade and Services">Office of Trade and Services</option>
