...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <input type="text" name="tk" value="<?php echo token::get("SMMELOGODELETEYASC");?>" required="" hidden>

            
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="button" class="btn btn-default" ><a href="edit.php">Cancel</a></button>
                <button type="submit" class="btn btn-danger" name="SMMELOGODELETE">Delete <span><i class="fa fa-trash"></i></span></button>
              </div> 
...
<button type="button" id="clicked" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="display:none"></button>
    ...
    <div class='align-self-center tab-content' style='display: flex; margin:auto ;'>
        <div id="" class='tab-pane fade in active' style="width: 50vw !important; margin:auto">
            <form id="behave" action="../Main/Main.php" method="POST" enctype="multipart/form-data">
                <?php $filepath = realpath(dirname(__FILE__));
                    include_once($filepath.'/../helpers/token.php');?>
                    <input type="text" name="tk" value="<?php echo token::get("SMMELOGOYASC");?>" required="" hidden>

                    <div class="col-md-6 col-sm-6 col-xs-12 custom-file">
                        <input style="border-style: none;" type="file" style="width:35vw" name='logo'  class="form-control col-md-7 col-xs-12 custom-file-input for" id="inputGroupFile01" >
                    </div>
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button name="SMMELOGOUPDATE" type="submit" class="btn btn-success">Submit</button>
                        </div>
                      </div>
