...
<!-----end of content---->
                ...
                <table>
                    ...
                    <tr>
                        <td id="move">
                            <input class="form-control col-md-7 col-xs-12" type="text" name='links[]' placeholder="Enter you business links here...">
                        </td>
                        <td id="move">
                ...
                <?php $filepath = realpath(dirname(__FILE__));
                      ...
                      <input style="display:none" type="text" name="tk" value="<?php echo token::get("smme_business_links");?>" required="" hidden>
