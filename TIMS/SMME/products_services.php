  ...
  <body class="nav-md">
    ...
    <div class='align-self-center tab-content' style='display: flex; margin:auto ;'>
        <div id="Direct_expense_table" class='tab-pane fade in active' style="width: 50vw !important; margin:auto">
            <form id="behave" action="../Main/Main.php" method="POST" enctype="multipart/form-data">
...
<!-----end of content---->
                ...
                <table style="margin:auto" class="pandservices">
        
                    <tbody id="tbody">
                      
                    <tr>
                        <td>
                            <input required="required" class="form-control col-lg-7 col-md-3 col-xs-12 formz" type="text" name='productname[]' placeholder="Enter Product name here...">
                        </td>
                    </tr>
                    <tr >
                        <td >
                            <input required="required"  class="form-control col-lg-7  col-md-3 col-xs-12 formz" type="text" name='productdes[]' placeholder="Enter product description here...">
                        </td>
                    </tr>
                    
                    <tr >
                        <td >
                            <input  class="form-control col-lg-7  col-md-3 col-xs-12 formz" type="number" name='productprice[]' placeholder="Enter product price here...">
                        </td>
                    </tr>
                    
                    <tr>
                        <td >
                            <input  class="form-control col-lg-7  col-md-3 col-xs-12 formz" type="file" name='productimg[]'>
                        </td>
                    </tr>
                ...
                <?php $filepath = realpath(dirname(__FILE__));
                      ...
                      <input style="display:none" type="text" name="tk" value="<?php echo token::get("submit_products");?>" required="" hidden>
<!-- <button class="btn" type="button" id="addItem">Add Item</button> -->
<div style="margin-left:300px" class="product"><input class="btn btn-success" type="submit" name="Products" ></div>
