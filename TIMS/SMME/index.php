...
<html lang="en">
  <head>
    ...
    <link href="../CSS/Vendor/shepherd-theme-arrows.css" rel="stylesheet">
  ...
  <input type="text" name="tk" id="tk" value="<?php echo token::get("SMME_ANALYTICS_YASC");?>" required="" hidden>
            <div class="clearfix"></div>
            

            <div class="row tile_count text-center" id="smme_analytics_header">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <canvas id="smme_connections_chart"></canvas>
                  </div>
                </div>
              </div>
 ...
 <hr>
  ...
  <div class="row tile_count text-center" id="smme_marketplace_header">
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="x_panel">
                    ...
                    <!--    <li style='float:left;margin: 5px'><div  style='background-color:#36a832; border:1px solid black; width:15px;height:10px'></div>Products</li>-->
                    <!--  </ul>-->
                      <canvas id="smme_search_chart"></canvas>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="x_panel">
                    ...
                    <!--  </ul>-->
                      <canvas id="smme_keyword_chart" ></canvas>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  ...
  <script src="../Javascript/Vendor/shepherd.min.js"></script>
  <script src="../Javascript/Ajax_header.js"></script>
  <script src="../Javascript/smme_analytics.js"></script>
