...
<!-----end of content---->
            <form id="question_form" data-parsley-validate class="form-horizontal form-label-left" action="../MARKET/ROUTE.php?d=1" Method="POST">
                <table>
                    ...
                    <tr>
                        ...
                        <td id="move">
                            <input class="form-control col-md-7 col-xs-12" type="number" name="weights[]"  required="">
                ...
                <?php $filepath = realpath(dirname(__FILE__));
                      ...
                      <input style="display:none" type="text" name="tk" value="<?php echo token::get("QUESTION_CREATION_OPENLINKS");?>" hidden>
                      <input style="display:none" type="text" name="SMME_QUESTION_CREATE" value="SMME_QUESTION_CREATE" required="" hidden>
            ...
            <?php 
                            if(isset($_GET['t'])){
                              switch($_GET['t']){
                                case 1://smme
                                    echo '<button type="Submit" id="QUESTION_CREATE" class="btn btn-success" name="SMME_QUESTION_CREATE">Submit</button>';
                                    break;
                                case 2: //company
                                  echo '<button type="Submit" id="QUESTION_CREATE" class="btn btn-success" name="COMPANY_QUESTION_CREATE">Submit</button>';
                                  break;
                                case 3://adimin
