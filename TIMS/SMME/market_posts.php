...
<style>
  ...
  <body class="nav-md">
                        ...
                        <div class="row">
                            ...
                            <div class="x_panel">
                                        ...
                                        <div class="x_title">
                                            ...
                                            <br>
                                        <br>
                                     <a href="create_post.php?t=1"><button type="button" class="btn btn-success btn-lg">New Post +
                                                    </button></a>
                                                   
                                             <a href="received_posts.php?t=1"><button type="button" class="btn btn-success btn-lg">  Jobs Recieved <i class="fa fa-inbox"></i>
                                                    </button></a>
                                                   
                                                   
                                                    <a href="all_posts.php?t=1"><button type="button" class="btn btn-success btn-lg"> All Post <i class="fa fa-inbox"></i>
                                                    </button></a> 
   ...
   <p style='color:red; font-size:20px'>The periodic posts below are post related to your industry</p>
                                        <div class="x_content">
                                            <div class="row">
