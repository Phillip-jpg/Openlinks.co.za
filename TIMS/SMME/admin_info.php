                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" style="width:35vw"  required="required" name="Surname"class="form-control col-md-7 col-xs-12 formz" type="text" >
                        </div>
                      </div>
                        <!-- Modal content-->
                  ...
                  <!-----end of content modal---->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" required="required" id="middle-name" name="IDNumber" class="form-control col-md-7 col-xs-12 formz" type="text" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name"  class="control-label col-md-3 col-sm-3 col-xs-12">Ethinic Group</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input style="width:35vw" id="middle-name" required="required" class="form-control col-md-7 col-xs-12 formz" name="Race" list="Ethnicc1">
            <datalist style="width:35vw" id="Ethnicc1" class="formz">
            <datalist id="Ethnicc1">
             ...
             <option value="Indian">Indian</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input required="required" style="width:35vw" id="middle-name" class="form-control col-md-7 col-xs-12 formz" type="text" name="Email">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Gender</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                <select style="width:35vw" name="Gender" size="1" class="form-control col-md-7 col-xs-12 formz">
                    ...
                    <!--Other not relavent-->
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("SMMEADMIN");?>" required="" hidden>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
						              <button class="btn btn-primary" type="reset" >Cancel</button>
                          <button type="submit" class="btn btn-success" name="SMMEADMIN">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
