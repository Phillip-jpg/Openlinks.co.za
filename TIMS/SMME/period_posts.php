                            ...
                            <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            $filepath = realpath(dirname(__FILE__));
                                                ...
                                                if (!empty($_GET['my'])) {
                                                    // If the 'my' GET parameter is not empty, display period posts based on 'p' GET parameter
                                                      // If the 'my' GET parameter is empty, display "my period" posts based on 'p' GET parameter
                                                    $temp->displaymyPeriodPosts($_GET['p']);
                                                  
                                                } else {
                                                    $temp->displayPeriodPosts($_GET['p']);
                                                }
                                                
                                                                                                
                                                
                                            ?> 
                                        </div><a  class="btn btn-primary" href="market_posts.php?t=1">Back</a>
                                    </div>
