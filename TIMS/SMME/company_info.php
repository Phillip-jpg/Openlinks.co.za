                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Trade Name<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw"  type="text" id="first-name" required="required" name="tradename" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw"  type="text" id="first-name" required="required" name="legalname" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw"  required="required" id="middle-name" class="form-control col-md-7 col-xs-12 formz" type="text" name="email">
                        </div>
                      </div>
                      <!-- Modal content-->
                  ...
                  <!-----end of content---->
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw"  type="text" id="last-name" name="address" required="required" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input required="required" style="width:35vw"  id="middle-name" class="form-control col-md-7 col-xs-12 formz" type="text" name="province">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input required="required" style="width:35vw"  id="middle-name" class="form-control col-md-7 col-xs-12 formz" type="text" name="city">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw"  type="number" id="number" name="postal" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">CIPC Registration<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw"  type="number" id="number" name="regnum" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" type="number" id="number" name="contact" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select style="width:35vw"  class="form-control col-md-7 col-xs-12 formz" name="offices" id="offices" required>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="width:35vw" type="date" id="number" name="financial" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12 formz">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <?php $filepath = realpath(dirname(__FILE__));
                      include_once($filepath.'/../helpers/token.php');?>
                      <input type="text" name="tk" value="<?php echo token::get("SMMEREGISTER");?>" required="" hidden>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
						  <button class="btn btn-primary" type="reset">Cancel</button>
                          <button name="SMMEREGISTER" type="submit" class="btn btn-success">Submit</button>
                        </div>
                      </div>
