...
<html lang="en">
  ...
  <div class="page-title">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Add criteria information </small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="CRITERIA_FORM" data-parsley-validate class="form-horizontal form-label-left" action="../MARKET/ROUTE.php" Method="POST">
                  ...
                  <!-----end of content modal---->
                      <!-- <div class="form-group">
                        ...
                        <input style="width:35vw" id="weight" required="required" placeholder="100%" class="form-control col-md-7 col-xs-12 formz" name="Weight[]" list="weights">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"><a  class="btn btn-primary" href="criteria_view.php?t=1">Back</a>
                            ...
                            if(isset($_GET['t'])){
                              switch($_GET['t']){
                                case 1://smme
                                    ...
                                    break;
                                case 2: //company
                                  echo '<button type="Submit" class="btn btn-success" id="CRITERIA_CREATE" name="COMPANY_CRITERIA_CREATE">Submit</button>';
                                  break;
                                case 3://adimin
                                  echo '<button type="Submit" class="btn btn-success" id="CRITERIA_CREATE" name="ADMIN_CRITERIA_CREATE">Submit</button>';
                                  break;
                              }
                            }
                          ?>
  ...
  <script src="../Javascript/weight_selection_criteria.js"></script>
