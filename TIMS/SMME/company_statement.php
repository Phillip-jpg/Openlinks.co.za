              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea style="width:35vw"  id="textarea" required="required" name="Introduction" class="form-control col-md-7 col-xs-1 formz"></textarea>
                        </div>
                      </div>
                      <div class="item form-group">
                  ...
                  <!-----end of content---->
                      ...
                      <input style="display:none" type="text" name="tk" value="<?php echo token::get("submit_statements");?>" required="" hidden>
