              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="control-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input id="tags_1" type="text" class="tags form-control" value="" name="keywords"/>
                  ...
                  <div class="ln_solid"></div>
                      ...
                      <input type="text" name="tk" value="<?php echo token::get("SMMEKEYWORDSYASC");?>" required="" hidden>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                   
						  <button class="btn btn-primary" type="reset" >Cancel</button>
                          <button type="submit" class="btn btn-success" name="SMMEKEYWORDS">Submit</button>
                  </form>
