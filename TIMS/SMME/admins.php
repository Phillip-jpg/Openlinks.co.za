        ...
        <?php require 'inc/header.php';?>
            ...
            <div class="right_col" role="main">
                ...
                <?php $filepath = realpath(dirname(__FILE__));
                      ...
                      <input type="text" id="tk" name="tk" value="<?php echo token::get("ADMINSDISPLAY");?>" required="" hidden>
                                    <?php require 'inc/search.php';?>
                                    <div class="clearfix"></div>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h3>Filter<span style="font-size:15px">(Industry, Sub Industry, Role, City, Province)</span> </h3><small>Select an option from the dropdown and press go to filter the table of admins. Then click the name of the admin to proceed to chat.</small>
                                        <?php 
...
<script src="../Javascript/Vendor/jquery-3.5.1.js"></script>
  ...
  <script src="../Javascript/updatemodal.js"></script>
    <!-- Custom Theme Scripts -->
    <script src="../Javascript/Ajax_header.js"></script>
    <script src="../Javascript/Admins.js" async></script>
    <script src='../Javascript/AdminsFilter.js' defer></script>
