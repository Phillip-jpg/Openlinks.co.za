...
}, 500)//toggle width of "SME" on index.html every 1 second
function showSide() {
    document.getElementById("loginArea").className += ' displaySide';
}//supported by an onclick in a button, sets #loginarea to .display side, increasing the width and showing the navigation. From style.css, employeepanel.html
function closeSide() {
    document.getElementById("loginArea").className = 'area';
}//supported by an onclick in a button, sets #loginarea back to .area, making the width 0 and hiding the navigation. From style.css, employeepanel.html
function a() {
    document.getElementById("adminLogin").className += ' displaySidee';
}//supported by an onclick in a button, sets #adminlogin to .displaysidee, increasing the width of the admin login to 100%. From style.css and the navigation on index.html
function closeSideOfCD() {
    document.getElementById("adminLogin").className = 'PanelForm';
}//supported by an onclick in a button, sets #adminlogin back to .adminpanellogin, making the width 0 and hiding the navigation. From style.css, index.html

function c() {
    document.getElementById("consultantLogin").className += ' displaySidee';
}//supported by an onclick in a button, sets #consultantlogin to .displaysidee, increasing the width of the admin login to 100%. From style.css and the navigation on index.html
function closeSideOfConsultantLogin() {
    document.getElementById("consultantLogin").className = 'consultantPanelLogin';
}//supported by an onclick in a button, sets #consultantlogin back to .consultantPanelLogin, making the width 0 and hiding the form. From style.css, index.html
//.adminpanellogin, .consultantpanellogin and .employeepanellogin are the same... we can make it one class
function e() {
    document.getElementById("employeeLogin").className += ' displaySidee';
}//supported by an onclick in a button, sets #employeeLogin to .displaysidee, increasing the width of the employee/sme login to 100%. From style.css and the navigation on index.html
function closeSideOfEmployeeLogin() {
    document.getElementById("employeeLogin").className = 'employeePanelLogin';
}//supported by an onclick in a button, sets #employeeLogin back to .employeePanelLogin, making the width 0 and hiding the form. From style.css, index.html
var adminAccount = {
...
function adminLogin() {
    ...
    if (email === adminAccount.email && password === adminAccount.password) {
        ...
        }, 2000)//loading is just flexing, no use either than clout
    }
    else {
        document.getElementById("error2").style.display = 'block';
    }//if password and email are correct then display logging in loading message, and hide error message incase. Then go to adminpanel ; else show error message
}
...
function consultantLogin() {
    ...
    if (email === adminAccount.email && password === adminAccount.password) {
        ...
        document.getElementById("error2").style.display = 'none';
        setTimeout(function () {
            location = 'consultantPanel.html'
        }, 2000)
    }
    else {
        document.getElementById("error2").style.display = 'block';
    }
}//if password and email are correct then display logging in loading message, and hide error message incase. Then go to consultantPanel ; else show error message
...
function signUpEmployee() {
    ...
    var a = localStorage.setItem("Employee_Account", JSON.stringify(employeeAccount));//wow
    document.getElementById("display").style.display = 'block';
    setTimeout(function () {
        location = 'employelogin.html'
    }, 2000)

};//takes in as input the name email and password 
...
function verify()
{
    location ='BusinessAdminInformation.html';
}
