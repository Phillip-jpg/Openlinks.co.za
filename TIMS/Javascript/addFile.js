const button1 = document.getElementById("addFile");
...
function addItem() {           
  ...
  label.textContent = "Upload RFP/RFI file";
  ...
  const formGroupDiv = document.getElementById("inputs");
  parent.appendChild(label);
  parent.appendChild(customFileDiv);
  formGroupDiv.appendChild(parent);
