			...
			<colgroup>
				...
				<thead style="background-color:#032033 !important; color:white">
					<tr>
						...
						<th>Duration in worktype</th>
						<th>Target</th>
						<th>Activity</th>
						<th>Responbility</th>
						<th>Minutes per Activity</th>
						<th>CLIENT</th>
						<th>Activity Name</th>
						<th>Job Start</th>
						<th>Job End</th>
						...
						<th>Job Done</th>
						<th>Set Duration</th>
						<th>Experiation Duration in Minutes</th>
						<th>Experied Duration per Activity</th>
						<th>Time Spent on Job</th>
				...
				<tbody>
					...
					<tr>
						<td>
							...
							<td>
								<p><?php echo ucwords($row['Month']) ?></p>
						</td>
                        <td>
                            <p>
                                <?php 
						...
						<td>
							<p>
                              <?php echo rtrim(rtrim($row['duration_worktype'], '0'), '.'); ?>
                            </p>
						...
						<td>
                            <p><?php echo intval(1 / $row['activity'] * 100); ?> %</p>
                        </td>

						<td>
                            <p>
                                <?php echo $row['duration_worktype'] / $row['target']; ?>
                                </p>
                        </td>
                        <td>
							<p><?php echo ucwords($row['company_name']) ?></p>
						</td>
						<td>
							<p><?php echo ucwords($row['activity_name']) ?></p>
						</td>
						<td>
						...
						<td>
							<p><?php echo ucwords($row['difference_in_days']) ?></p>
						</td>
						<td>
							<p><?php echo ucwords($row['Experiation_Min']) ?></p>
						</td>
						<td>
							<p><?php echo ucwords($row['Experiation_Min']/$row['target']) ?></p>
						</td>
						<td>
                            <p>
                                <?php 
	                    ...
	                    <td>
                            <p><?php echo number_format($time_spend_on_job / ($row['duration_worktype'] / $row['target']), 2); ?>
                            </p>
                        </td>
                         <td>
                            <p><?php 
				 ...
				 <div class="container mt-4">
                    <div class="card">
                        <div class="card-header bg-success text-white">
                            ...
                            <h4>Work type: <?php echo $taskname ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    <p>Team average time to complete a Job : <span style="font-weight:bold"> <?php echo number_format($timespent/$donecount); ?></span></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
