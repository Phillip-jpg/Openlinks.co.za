					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" >
		                      <a class="dropdown-item view_project" href="./index.php?page=my_team_jobs_to_manage_lvl_1&team_id=<?php echo $teamRef ?>" data-id="<?php echo $row['team_ids'] ?>">View Jobs</a>
		                      <hr>
