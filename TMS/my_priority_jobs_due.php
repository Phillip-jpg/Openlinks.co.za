...
?>
            	...
            	<table class="table table-hover table-bordered table-condensed" id="list">
                        ...
                        echo "<td>";
                              if ($row['status'] == 'Done') {
                                echo '<a href="index.php?page=job_finalised&activity_id=' . $row['activity_id'] . '&project_id=' . $row['project_id'] . '&priority=value" style="color:white"><span class="badge badge-success">' . $row['status'] . ': View</span></a>';
                            ...
                            if ($row['request_done'] == 0) {
                                    echo '<td><button class="badge badge-info" style="border-radius: 5px;"><a href="./index.php?page=job_finalisation&activity_id=' . $row['activity_id'] . '&project_id=' . $row['project_id'] . '&priority=value" style="color:white">Request</a></button></td>';
