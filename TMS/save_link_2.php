...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['CLIENT_ID'])) {
        ...
        $LINK_NAME=$_POST['link_name'];
               ...
               $insertQuery = $conn->prepare("INSERT INTO level_two_links (CLIENT_ID, WorkType_ID, LINK, LINK_NAME) VALUES (?, ?, ?,?)");
                $insertQuery->bind_param('iiss', $CLIENT_ID,$WORKTYPE_ID, $LINK, $LINK_NAME);
                $insertQuery->execute();
            
          
if ($insertQuery) {
    echo "<p style='color:green; font-size:20px; font-weight:bold'>Data saved successfully!</p>";
   echo "<a href='index.php?page=add_link_lvl2&CLIENT_ID=" . $CLIENT_ID . "&task_id=".$WORKTYPE_ID."'>
