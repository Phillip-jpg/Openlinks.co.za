...
if ($CLIENT_ID > 0) {
    ...
    $Client = $conn->query("SELECT c.company_name, tl.task_name, pl.name  
    FROM yasccoza_openlink_market.client c, task_list tl, project_list pl 
    ...
    if ($Client && $Client->num_rows > 0) {
        ...
        $worktype_name = htmlspecialchars($row['task_name']); 
        $job_name = htmlspecialchars($row['name']);// Sanitize for output
    } else {
...
<div class="container mt-5">
    <div class="card shadow-lg p-4">
        ...
        <h6 class="text-center text-secondary">WorkType: <?php echo $worktype_name; ?></h6>
         <h6 class="text-center text-secondary">Job: <?php echo  $job_name; ?></h6>
        <div class="card-body">
            <form id="manage-account" method="post" action="./index.php?page=save_link_3">
                <div class="row">
                    <!-- Link Input -->
                ...
                <div class="text-center mt-4">
                   ...
                   <button class="btn btn-secondary" type="button" 
                            onclick="location.href = 'index.php?page=client_management_lvl_3&CLIENT_ID=<?php echo $CLIENT_ID; ?>&task_id=<?php echo $WORKTYPE_ID; ?>&job_id=<?php echo $JOB_ID; ?>'">
                            Back
                        </button>
