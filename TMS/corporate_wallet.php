...
<div class="container mt-4">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <p><strong>Total Net Contribution to Team: </strong><br> R <?php echo number_format($total_net_contribution,2); ?></p>
                </div>
                <div class="col-md-3">
                    <p><strong>Value lost to Date: </strong><br> R <?php echo number_format($value_lost,2); ?></p>
                </div>
                <div class="col-md-3">
                    <p><strong>Total Net Contribution to Team to Date : </strong><br> R <?php echo number_format($total_net_to_date,2); ?></p>
                </div>
            </div>
