				 ...
				 <div class="container mt-4">
                    <div class="card">
                        <div class="card-header bg-success text-white">
                            ...
                            <h4>Activity name: <?php echo $activity_name ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    <p>Total Minutes by duration of work type : <span style="font-weight:bold"> <?php echo number_format($Total_Min_by_duration_wt); ?></span></p>
                                </div>
                                <div class="col-md-4">
